...
public class MoveAgent : MonoBehaviour
{
    ...
    //_patrolling 프로퍼티 정의(getter, setter)
    ...
    void Start()
    {
        //적 캐릭터의 Tranform 컴포넌트 추출 후 변수에 저장
        ...
        if(group != null)
        {
            //하이러키 뷰의 WayPointGroup 하위에 있는 모든 Transform 컴포넌트를 추출한 후
            //List 타입의 wayPoint 배열에 추가
    ...
    void MoveWayPoint()
    {
        //최단거리 경로 계산이 끝나지 않았으면 다음 을 수행하지 않음
