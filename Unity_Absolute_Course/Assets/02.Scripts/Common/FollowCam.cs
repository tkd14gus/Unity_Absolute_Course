...
public class FollowCam : MonoBehaviour
{
    ...
    public float moceDamping    = 15.0f;    //이동 속도 계수
    ...
    void Update()
    {
        ...
        //주인공이 장매물에 가려졌는지를 판단할 레이캐스트의 높낮이를 설정
    ...
    //주인공 캐릭터의 이동 로직이 롼료된 후 처리하기 위해 LateUpdate에서 구현
    void LateUpdate()
    {
        //카메라의 높이와 거리를 계산
