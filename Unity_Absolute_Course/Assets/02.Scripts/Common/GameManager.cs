...
public class GameManager : MonoBehaviour
{
    ...
    //ItmeList 하위에 있는 네 개의 아이템을 저장할 배열
    ...
    void LoadGameData()
    {
        ...
        //killCountTxt.text = "KILL " + data.killCount.ToString("0000");
    ...
    void InventorySetup()
    {
        ...
        for (int i = 0; i < gameData.equipItem.Count; i++)
        {
            ...
            for (int j = 0; j < slots.Length; j++)
            {
                ...
                //아이템의 ItemInfo 클래스의 itmeData에 로드한 데이터 값을 저장
    ...
    void Start()
    {
        ...
        //하이러키 뷰의 SqwnPointGroup을 찾아 하위에 있는 모든 Transform 컴포넌트를 찾아옴
